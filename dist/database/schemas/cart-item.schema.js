...
let CartItem = class CartItem extends mongoose_2.Document {
};
...
exports.CartItem = CartItem = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: 'cart_items' })
], CartItem);
exports.CartItemSchema = mongoose_1.SchemaFactory.createForClass(CartItem);
exports.CartItemSchema.index({ userId: 1, productId: 1 }, { unique: true });
exports.CartItemSchema.index({ userId: 1 });
