...
let ProductImage = class ProductImage extends mongoose_2.Document {
};
...
exports.ProductImage = ProductImage = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true, collection: 'product_images' })
], ProductImage);
exports.ProductImageSchema = mongoose_1.SchemaFactory.createForClass(ProductImage);
exports.ProductImageSchema.index({ productId: 1 });
